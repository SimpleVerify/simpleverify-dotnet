...
namespace SimpleVerify
{
    public class VerificationsResource
    {
        ...
        {
            return _apiClient.RequestAsync<Verification>(HttpMethod.Post, "/api/v1/verify/send", request, cancellationToken);
        }
        ...
        public Task<VerificationCheck> CheckAsync(string verificationId, string code, CancellationToken cancellationToken = default)
        {
            ...
            return _apiClient.RequestAsync<VerificationCheck>(HttpMethod.Post, "/api/v1/verify/check", body, cancellationToken);
        }
